...
const codeBox = { backgroundColor: '#f3f4f6', borderRadius: '8px', padding: '24px', textAlign: 'center' as const, fontFamily: 'monospace', fontSize: '32px', fontWeight: 'bold' as const, letterSpacing: '8px', color: '#22c55e', margin: '0 0 25px' }
