  ...
  <Html lang="de" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Wir haben eine Anfrage erhalten, dein Passwort für 3DMuscio zurückzusetzen. Klicke auf den Button um ein neues Passwort zu wählen.</Text>
        <Button style={button} href={confirmationUrl}>Passwort zurücksetzen</Button>
        <Text style={footer}>Falls du keine Passwort-Zurücksetzung angefordert hast, kannst du diese E-Mail ignorieren.</Text>
        <Hr style={divider} />
