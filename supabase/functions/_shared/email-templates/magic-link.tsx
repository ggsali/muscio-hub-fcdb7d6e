...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Dein Login-Link für 3DMuscio</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Mit einem Klick einloggen</Heading>
        <Text style={text}>Klicke auf den Button um dich bei 3DMuscio einzuloggen. Der Link ist nur kurze Zeit gültig.</Text>
        <Button style={button} href={confirmationUrl}>Jetzt einloggen</Button>
        <Text style={footer}>Falls du diesen Link nicht angefordert hast, kannst du diese E-Mail ignorieren.</Text>
        <Hr style={divider} />
...
const header = { backgroundColor: '#22c55e', borderRadius: '12px', padding: '20px 24px', marginBottom: '28px', display: 'flex' as const, alignItems: 'center' as const, gap: '14px' }
...
const button = { backgroundColor: '#22c55e', color: '#ffffff', fontSize: '14px', borderRadius: '8px', padding: '12px 20px', textDecoration: 'none' }
