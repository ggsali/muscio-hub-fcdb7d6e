...
const successBox: React.CSSProperties = { background: '#fff7ed', border: '1px solid #fdba74', borderRadius: '8px', padding: '14px 18px', margin: '0 0 20px' }
const successTitle: React.CSSProperties = { margin: 0, fontSize: '15px', fontWeight: 700, color: '#FF5A00' }
...
const amountValue: React.CSSProperties = { margin: 0, fontSize: '22px', fontWeight: 700, color: '#FF5A00' }
