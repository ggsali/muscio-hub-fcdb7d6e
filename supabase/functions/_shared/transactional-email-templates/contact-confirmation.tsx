...
const Email = ({ name, message }: Props) => (
  <Html lang="de" dir="ltr">
    <Head />
    <Preview>Nachricht erhalten</Preview>
        ...
        <Section style={{ backgroundColor: '#18181b', padding: '20px 28px', borderRadius: '12px 12px 0 0' }}>
          <table role="presentation" cellPadding={0} cellSpacing={0} border={0} width="100%" style={{ borderCollapse: 'collapse' }}>
            <tr>
              ...
              <td align="right" style={{ verticalAlign: 'middle', fontSize: '26px' }}>✉️</td>
            </tr>
          </table>
        </Section>

        <Section style={{ backgroundColor: '#ffffff', border: '1px solid #e5e7eb', borderTop: 'none', borderRadius: '0 0 12px 12px', padding: '32px 28px' }}>
          <Text style={{ fontSize: '22px', fontWeight: 700, color: '#18181b', margin: '0 0 16px' }}>Nachricht erhalten</Text>
          ...
          {message ? (
            <>
              <Text style={{ fontSize: '14px', lineHeight: 1.6, color: '#3f3f46', margin: '0 0 8px' }}><strong>Ihre Nachricht:</strong></Text>
          ...
          <Text style={{ fontSize: '14px', lineHeight: 1.6, color: '#3f3f46', margin: '0 0 14px' }}>
            Mit freundlichen Grüssen<br /><strong>3DMuscio</strong>
          </Text>
        </Section>
