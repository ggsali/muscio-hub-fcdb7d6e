...
const logo: React.CSSProperties = { fontSize: '20px', fontWeight: 700, color: '#18181b' }
...
const link: React.CSSProperties = { color: '#FF5A00', textDecoration: 'none' }
const button: React.CSSProperties = { backgroundColor: '#FF5A00', color: '#ffffff', padding: '12px 24px', borderRadius: '8px', textDecoration: 'none', fontSize: '14px', fontWeight: 600, display: 'inline-block' }
