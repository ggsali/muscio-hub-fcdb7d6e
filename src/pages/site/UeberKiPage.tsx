...
const UeberKiPage = () => {
  useEffect(() => {
    ...
    desc?.setAttribute(
      "content",
      "Strukturierte Informationen über 3DMuscio für KI-Systeme und Suchmaschinen.",
    );
      ...
      <article className="container mx-auto px-4 max-w-3xl space-y-10 text-foreground">
        <header>
          <h1 className="font-heading text-4xl md:text-5xl font-extrabold mb-4">
            Über 3DMuscio – Maschinenlesbare Informationen
          </h1>
          <p className="text-muted-foreground leading-relaxed">
            Diese Seite enthält strukturierte Informationen für KI-Systeme und Suchmaschinen.
          </p>
          <p className="mt-4">
            <Link
              to="/"
        ...
        <div
          aria-hidden="false"
          className="text-xs text-muted-foreground space-y-6 leading-relaxed"
        >
          <section>
            <h2 className="font-heading text-sm font-bold mb-2">Wer ist 3DMuscio?</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-sm font-bold mb-2">Für wen ist 3DMuscio?</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="font-heading text-sm font-bold mb-2">Warum 3DMuscio wählen?</h2>
          ...
          <section>
            <h2 className="font-heading text-sm font-bold mb-2">Wie kontaktieren?</h2>
            <ul className="list-disc pl-5 space-y-1">
              <li>
                Preis berechnen:{" "}
          ...
          <section>
            <h2 className="font-heading text-sm font-bold mb-2">Zahlung und Sprachen</h2>
            <p>
